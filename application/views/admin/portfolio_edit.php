                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                            <div class="card">
                                <div class="header">
                                    ...
                                    <input type="hidden" name="portfolioId" value="<?php echo $portfolio['portfolio_id'] ?>">
                                </div>
                                <div class="body">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <div class="card">
                                ...
                                <div class="body">
                                <label for="featuredImage01_TUNDA">
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <div class="card">
                                ...
                                <div class="body">
                                <label for="featuredImage02_TUNDA">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <div class="card">
                                ...
                                <div class="body">
                                <label for="featuredImage03_TUNDA">
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content modal-col-blue-grey">
                        <div class="modal-header">
                            <h4 class="modal-title" id="smallModalLabel">UPDATE PROJECT</h4>
                        </div>
