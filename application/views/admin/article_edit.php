            ...
            <?php echo form_open_multipart('article/article_update'); ?>
                ...
                <script>
                    tinymce.init({ 
                        ...
                        toolbar2: 'link image media preview | forecolor backcolor emoticons',
                        image_advtab: true
                    });
                </script>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row clearfix" >
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                <div class="card">
                                    <div class="header">
                                        <h2>Update - <?php echo $post['post_title'] ?></h2>
                                        <input type="hidden" name="articleId" value="<?php echo $post['posts_id'] ?>">
                                    </div>
                                    <div class="body">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" name="articleTitle" class="form-control" value="<?php echo $post['post_title'] ?>" />
                                                <label class="form-label"></label>
                                            </div>
                                            <div class="form-line" style="margin: 15px 0 0px 0">
                                                <textarea rows="12" name="articleBody" id="tinymce" ><?php echo $post['post_body'] ?></textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="body" style="text-align:center">
                                        <div class="switch" style="text-align:center; margin:0 0 15px 20px">
                                            <label>Article<input type="checkbox" name="articleStatus" 
                                                <?php 
                                        ...
                                        <div class="switch" style="text-align:center; margin:0 0 15px 0">
                                            <label>Concept<input type="checkbox" name="articlePublish" <?php 
                                        ...
                                        <button type="button" data-toggle="modal" data-target="#createModal" style="margin-left:5px; width:310px" class="btn btn-material btn-lg btn-primary waves-effect">UPDATE</button>   
                                    </div>
                                </div>
                            </div>
                             <!--end option-->
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                <div class="card">
                                    ...
                                    <label for="articleImage">
                                        <input type="" name="articleImage" id="articleImage" style="display:none;" onchange="readIMG01(this);"/>
                                        <img id="img01" name="img01" src="<?php echo base_url();?>assets/images/post/<?php echo $post['post_image'] ?>" height="217px" width="326px"/>
                                    </label>
                                ...
                                <div class="card">
                                    ...
                                    <div class="body">                         
                                        ...
                                        <div class="form-group demo-tagsinput-area">
                                            <div class="form-line">
                                                <input type="text" name="articleTags" class="form-control" id="articleTags" data-role="tagsinput" value="<?php echo $post['post_tag'] ?>"/>
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content modal-col-blue-grey">
                            <div class="modal-header">
                                <h4 class="modal-title" id="smallModalLabel">UPDATE ARTICLE</h4>
                            </div>
                ...
                <!--images JavaScript fix update dimatikan-->
                <!--script>
                    function readIMG01s(input) {
